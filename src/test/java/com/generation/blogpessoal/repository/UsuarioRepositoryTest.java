...
void start(){
	...
	usuarioRepository.save(new Usuario(0L, "João da Silva", "joao@email.com.br", "13465278", //0L é pq eu não sei o ID
...
@Test
@DisplayName("🐯Retorna 1 usuario") //windows + . para adicionar o emoji
